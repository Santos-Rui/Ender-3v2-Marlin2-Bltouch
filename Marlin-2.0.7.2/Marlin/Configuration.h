 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43,-15, -1.5 } //ruca
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST ) //ruca (Z_PROBE_SPEED_FAST / 2)
...
#define DELAY_BEFORE_PROBING 50  // (ms) To prevent vibrations from triggering piezo sensors ruca
...
// The size of the print bed //ruca
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 251 //X_BED_SIZE
#define Y_MAX_POS 227 //Y_BED_SIZE
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 7   //ruca
